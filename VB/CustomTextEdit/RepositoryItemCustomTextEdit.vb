...
Namespace CustomTextEdit
	...
	Public Class RepositoryItemCustomTextEdit
		...
		Public Shared Sub Register()
			EditorRegistrationInfo.Default.Editors.Add(New EditorClassInfo(CustomTextEditName, GetType(MyCustomTextEdit), GetType(RepositoryItemCustomTextEdit), GetType(TextEditViewInfo), New TextEditPainter(), True))
		End Sub
		...
		Private Sub ShowNullPrompt()
			...
			If OwnerEdit IsNot Nothing AndAlso OwnerEdit.IsHandleCreated AndAlso (Not String.IsNullOrEmpty(NullValuePrompt)) Then
				SendMessage(OwnerEdit.MaskBox.Handle, &H1501, New IntPtr(behaviour), NullValuePrompt)
			End If
		End Sub
